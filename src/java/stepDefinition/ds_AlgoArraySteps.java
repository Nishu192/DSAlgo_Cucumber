...
//	}
	...
	@Given("The user is already on the tryEditor page")
	public void the_user_is_already_on_the_try_editor_page() {
		 ap=new Arrays_PF(BaseClass.getDriver());
	}

	@When("User can see output in the console")
	public void user_can_see_output_in_the_console() {
